...
OR (CmdLine Contains Anycase "Set-MpPreference -DisableRealtimeMonitoring" AND NOT (SrcProcPublisher = "OPEN TEXT CORPORATION" OR SrcProcPublisher = "PHAROS SYSTEMS INTERNATIONAL, INC"))
